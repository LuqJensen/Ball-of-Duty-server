...
namespace GameObjectImpl.GameObjects.Components.Physics.Collision
{
    public class CollisionHandler
    {
        ...
        public static int GetFirstObjectIntersectingPath<T>(ICollection<GameObject> gameobjects, GameObject gameobjectWithPath, int mapSize)
        {
